...
class Library extends Component {
	...
	renderEmptyLibrary() {
		...
		return (
			<div className={classes.emptyPage}>
				<Typography className={classes.headline} type="headline"><FontAwesome icon={FA.book} name={FA.book} /></Typography>
				<Typography type="title">It looks like your library is empty.</Typography>
				<Typography type="subheading">Click the button in bottom right corner to add your eBooks!</Typography>
			</div>
		);
	}
	...
	render() {
		...
		return (
			<AsPageContent>
				<div className={CLASS}>
					<Button variant="fab" color="secondary" aria-label="add_books" className={classes.floatButton}>
